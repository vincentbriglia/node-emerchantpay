...
describe('ParamSigner', function () {
    ...
    it('should allow url to be set', function (done) {
        ...
        assert.equal(ps.getUrl(), 'https://payment-xxxxxxx.emerchantpay.com/payment/form/post', 'error setting url');
    ...
    it('should return a valid querystring', function (done) {
        ...
        assert.equal(ps.getQueryString(), 'PS_SIGNATURE=115ed2f366e9f98998c73e55edad7437&PS_EXPIRETIME=86400&PS_SIGTYPE=md5', 'error getting querystring');
    ...
    it('should return a valid url', function (done) {
        ...
        assert.equal(ps.getUrlWithQueryString(), 'https://payment-xxxxxxx.emerchantpay.com/payment/form/post?PS_SIGNATURE=115ed2f366e9f98998c73e55edad7437&PS_EXPIRETIME=86400&PS_SIGTYPE=md5', 'error getting url');
    ...
    it('should return a valid signature', function (done) {
        ...
        assert.equal(ps.getSignature(), '115ed2f366e9f98998c73e55edad7437', 'error getting signature string');
        ps.setSignatureType('sha1');
        assert.equal(ps.getSignature(), 'f0ceb50b62a291b078de9f8f5c9e3c8a54164560', 'error getting signature string');
